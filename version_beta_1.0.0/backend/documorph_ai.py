    ...
    try:
        if doc_path.endswith('.docx'):
            ...
            with preview_container:
                # Use a custom HTML wrapper for better formatting
                html = f"""
    ...
    try:
        ...
        if num_rows > 0:
            ...
            for cell in header_row.cells:
                ...
                run = cell_para.runs[0] if cell_para.runs else cell_para.add_run(cell.text)
                run.bold = True
...
def main():
    ...
    with st.sidebar:
        ...
        feature_selection = st.radio(
            "Select Feature:",
            ["Upload & Process Document", "Template Management", "Document Enhancement", "Tables & Figures", "Live Document Editor", "Preview & Export"]
        )
